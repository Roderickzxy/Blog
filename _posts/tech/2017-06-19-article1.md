...
summary: "springmvc配置converter需要注意的地方"
...
[![attache1]({{ site.article_attachedimages | relative_url }}/tech/article1-attache1.png)]({{ site.article_attachedimages | relative_url }}/tech-article1-attache1.png)  
这些值如何获取呢，看源码：  
{% highlight java %}
/** 
